...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    return (
        <AuthLayout title="Iniciar sesión" description="Ingresa tu correo y contraseña para continuar">
            <Head title="Login" />

            <form className="flex flex-col gap-6 max-w-md w-full mx-auto mt-10" onSubmit={submit}>
